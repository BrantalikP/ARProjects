...
class MainVC: UIViewController {
    ...
    var routes: [Route] = [Route(name: "Basics", segueId: K.basicsSegue),Route(name: "VirtualText", segueId: K.virtualTextSegue),Route(name: "Multiple Objects", segueId: K.multipleSegue)]
